...
import { ChevronLeft, ExternalLink, Box, Calendar, User, Briefcase, CheckCircle2, ChevronRight } from 'lucide-react';
            ...
            <div className="space-y-8">
               <div className="bg-gray-50 p-8 rounded-[40px] border border-gray-100 space-y-6">
                 <div className="space-y-4">
                   <MetaItem icon={User} label="Project For" value={project.projectFor} />
                   <MetaItem icon={Briefcase} label="Role" value={project.role} />
                   <MetaItem icon={Calendar} label="Year" value={project.year} />
                   <MetaItem icon={CheckCircle2} label="Status" value={project.status} />
                 </div>

                 <div className="pt-6 border-t border-gray-200">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter mb-4">Technology Stack</p>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
           ...
           <div className="flex gap-4">
             ...
             <div className="text-center md:text-right">
               <p className="text-gray-400 text-xs font-bold uppercase tracking-tighter">Ready to build something?</p>
               <button 
